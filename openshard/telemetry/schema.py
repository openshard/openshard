...
AGENTS = ("claude_code", "codex", "opencode", "cursor", "antigravity", "grok_build", "native", "wrap", "import", "other")
...
EVENT_TYPES: dict[str, dict[str, Validator]] = {
    ...
    "setup.completed": {
        "agents": _token_list("claude_code", "codex", "opencode", "cursor", "antigravity", "grok_build"),
        "mcp": _bool,
