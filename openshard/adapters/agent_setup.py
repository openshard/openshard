"""Codex, OpenCode, Cursor, Google Antigravity and Grok Build integration detection and setup (PR12).
...
SUPPORTED_AGENTS: tuple[str, ...] = (
    AGENT_CODEX, AGENT_OPENCODE, AGENT_CURSOR, AGENT_ANTIGRAVITY, AGENT_GROK_BUILD,
)
