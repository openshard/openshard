...
class TestCapturePaths:
    def test_hook_session_with_a_test_command_records_unknown_agent_reported(self, repo):
        ...
        assert block["source"] == "agent_reported" and block["observation_mode"] == "hook_tool_event"
        ...
        assert "[agent_reported]" in payload["verification_reason"]
...
class TestOldReceipts:
    ...
    def test_old_hook_record_derives_unknown_from_its_events(self):
        ...
        assert d["status"] == "unknown" and d["source"] == "agent_reported"
...
class TestSerialization:
    @pytest.mark.parametrize("block", [
        ...
        v.build_verification(source="agent_reported", observation_mode="hook_tool_event", checks_attempted=0),
        v.build_verification(source="agent_reported", observation_mode="hook_tool_event", status="unknown",
    ...
    def test_sync_payload_stays_within_the_hosted_contract(self):
        ...
        assert envelope.WITHHELD_RECEIPT_KEYS == {"verification"}
